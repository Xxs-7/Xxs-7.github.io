...
随后出现了 @font-face 来加载第三方字体。浏览器解析到 @font-face 语句后，并不会立马加载字体而是会继续解析 DOM tree，仅当定义的字体被使用到了，字体库文件才会进行下载。
...
发散一下思维，这篇[文章](https://juejin.cn/post/7022897665302560782)描述了 SPA 在使用自定义字体库各个阶段可能遇到的问题。
